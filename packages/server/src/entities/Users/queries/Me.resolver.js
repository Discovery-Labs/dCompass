...
var MeResolver = /** @class */ (function () {
    function MeResolver(userService) {
        this.userService = userService;
    }
    MeResolver.prototype.me = function (siwe) {
        return __awaiter(this, void 0, void 0, function () {
            var chainSpecificAddress, foundUser;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        chainSpecificAddress = "".concat(siwe.address, "@eip155:").concat(siwe.chainId);
                    ...
                    case 1:
                        foundUser = (_a.sent())[0];
                        return [2 /*return*/, (0, helpers_1["default"])(foundUser)];
                }
            });
        });
    };
    __decorate([
        (0, graphql_1.Query)(function () { return User_entity_1.User; }, {
            nullable: true,
