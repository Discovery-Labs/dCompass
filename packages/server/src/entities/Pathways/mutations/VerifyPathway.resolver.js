...
exports.VerifyPathwayResolver = void 0;
...
var VerifyPathwayResolver = /** @class */ (function () {
    function VerifyPathwayResolver(appService, pathwayService) {
        this.appService = appService;
        this.pathwayService = pathwayService;
    }
    VerifyPathwayResolver.prototype.verifyPathway = function (siwe, _a) {
        var id = _a.id;
        return __awaiter(this, void 0, void 0, function () {
            var foundPathway, project, projectStreamId, address, chainId, projectContributors, chaindIdStr, verifyContract, pathwayContract, _b, metadataNonceId, thresholdNonceId, _c, metadataVerify, tresholdVerify;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        projectContributors = project.squads.flatMap(function (squad) { return squad.members; });
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, (0, helpers_1["default"])(__assign(__assign({}, foundPathway), { id: id, projectStreamId: projectStreamId, expandedServerSignatures: [
    ...
    ], VerifyPathwayResolver.prototype, "verifyPathway");
    VerifyPathwayResolver = __decorate([
        (0, graphql_1.Resolver)(function () { return Pathway_entity_1.Pathway; })
    ], VerifyPathwayResolver);
    return VerifyPathwayResolver;
}());
exports.VerifyPathwayResolver = VerifyPathwayResolver;
