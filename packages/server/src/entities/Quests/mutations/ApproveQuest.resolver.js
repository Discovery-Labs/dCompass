...
exports.ApproveQuestResolver = void 0;
...
var ApproveQuestResolver = /** @class */ (function () {
    function ApproveQuestResolver(questService, appService) {
        this.questService = questService;
        this.appService = appService;
    }
    ApproveQuestResolver.prototype.approveQuest = function (siwe, _a) {
        var id = _a.id, questType = _a.questType;
        return __awaiter(this, void 0, void 0, function () {
            var foundQuest, address, chainId, pathway, project, projectContributors, updatedQuest, chaindIdStr, verifyContract, badgeNFTContract, _b, metadataNonceId, thresholdNonceId, _c, metadataVerify, tresholdVerify;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 4:
                        ...
                        updatedQuest = null;
                        if (!(questType === "quiz")) return [3 /*break*/, 6];
                    ...
                    case 5:
                        updatedQuest = _d.sent();
                        _d.label = 6;
                    case 6:
                        if (!(questType === "bounty")) return [3 /*break*/, 8];
                    ...
                    case 8:
                        ...
                        badgeNFTContract = this.appService.getContract(chaindIdStr, "BadgeNFT");
                    ...
                    case 10:
                        ...
                        return [2 /*return*/, (0, helpers_1["default"])(__assign(__assign({}, updatedQuest), { expandedServerSignatures: [
    ...
    ], ApproveQuestResolver.prototype, "approveQuest");
    ApproveQuestResolver = __decorate([
        (0, graphql_1.Resolver)(function () { return Quest_entity_1.Quest; })
    ], ApproveQuestResolver);
    return ApproveQuestResolver;
}());
exports.ApproveQuestResolver = ApproveQuestResolver;
