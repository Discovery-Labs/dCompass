...
exports.CreateProjectOutput = void 0;
var graphql_1 = require("@nestjs/graphql");
var class_validator_1 = require("class-validator");
var CreateProjectOutput = /** @class */ (function () {
    ...
    ], CreateProjectOutput.prototype, "id");
    __decorate([
        (0, graphql_1.Field)(function () { return [String]; }),
        (0, class_validator_1.IsDefined)({ message: "not.defined" }),
        (0, class_validator_1.IsNotEmpty)({ message: "not.empty" })
    ], CreateProjectOutput.prototype, "tokenUris");
    __decorate([
        (0, graphql_1.Field)(function () { return Boolean; }, { defaultValue: false }),
        (0, class_validator_1.IsDefined)({ message: "not.defined" }),
        (0, class_validator_1.IsNotEmpty)({ message: "not.empty" })
    ], CreateProjectOutput.prototype, "isFeatured");
    CreateProjectOutput = __decorate([
