...
var CreateProjectInput = /** @class */ (function () {
    function CreateProjectInput() {
    }
    CreateProjectInput._GRAPHQL_METADATA_FACTORY = function () {
    ...
    ], CreateProjectInput.prototype, "id");
    __decorate([
        (0, graphql_1.Field)(function () { return [String]; }),
        (0, class_validator_1.IsDefined)({ message: "not.defined" }),
        (0, class_validator_1.IsNotEmpty)({ message: "not.empty" })
    ], CreateProjectInput.prototype, "tokenUris");
