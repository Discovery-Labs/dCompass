...
var CreateTagResolver = /** @class */ (function () {
    function CreateTagResolver() {
    }
    CreateTagResolver.prototype.createTag = function (_a, tag) {
        var _b;
        var ceramicClient = _a.ceramicClient;
        return __awaiter(this, void 0, void 0, function () {
            var createdTag, existingTags, tags;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, ceramicClient.model.createTile(idx_1.schemaAliases.TAG_ALIAS, tag)];
                    case 1:
                        createdTag = _c.sent();
                        if (!createdTag) {
                    ...
                    case 2:
                        ...
                        tags = (_b = existingTags === null || existingTags === void 0 ? void 0 : existingTags.tags) !== null && _b !== void 0 ? _b : [];
                        return [4 /*yield*/, ceramicClient.dataStore.set('tags', {
                                tags: __spreadArray([
                                    {
                    ...
                    case 3:
                        _c.sent();
                        return [2 /*return*/, __assign({ id: createdTag.id.toUrl() }, createdTag.content)];
                }
            });
        });
    };
    ...
    ], CreateTagResolver.prototype, "createTag");
    CreateTagResolver = __decorate([
