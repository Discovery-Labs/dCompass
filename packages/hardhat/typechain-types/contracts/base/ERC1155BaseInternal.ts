...
export interface InternalApprovalForAllEventObject {
  account: string;
  operator: string;
  approved: boolean;
}
...
export type InternalTransferSingleEvent = TypedEvent<
  [string, string, string, BigNumber, BigNumber],
  InternalTransferSingleEventObject
>;
