...
export interface BadgeNFTInterface extends utils.Interface {
  functions: {
    ...
    "createBadge(string,string,uint256,bool,address,bool,uint256,address)": FunctionFragment;
    "createBadgeAndVote(address[],string,string,bytes32[2],bytes32[2],uint8[2],uint256,uint256,bool[2],address,uint256,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "createBadgeAndVote",
    values: [
      string[],
      string,
      string,
...
export interface BadgeApprovedEventObject {
  _badgeId: string;
}
export type BadgeApprovedEvent = TypedEvent<[string], BadgeApprovedEventObject>;

export type BadgeApprovedEventFilter = TypedEventFilter<BadgeApprovedEvent>;

export interface NFTBadgeMintedEventObject {
  _to: string;
  _tokenURI: string;
  _badgeId: string;
}
